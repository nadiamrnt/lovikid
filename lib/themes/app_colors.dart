...
class AppColors {
  // General
  static const Color primary = Color(0xff84b797);
  static const Color onPrimary = Color(0xff0cc9ad);
  static const Color primaryVariant = Color(0xffBD0909);
  static const Color primaryDisable = Color(0xffF18E8E);
  static const Color secondary = Color(0xff007560);
  static const Color secondaryDisable = Color(0xff6abf72);
  ...
  Color containerThemeColor =
      (Get.isDarkMode) ? Get.context!.theme.dialogBackgroundColor : systemGrey;
  ...
  static MaterialColor materialPrimary = MaterialColor(0xffBD0909, color);
}
